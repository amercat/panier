                        ...
                        <div class="flow-root">
                            <ul class="-my-8">
                                <li class="flex flex-col space-y-3 py-6 text-left sm:flex-row sm:space-x-5 sm:space-y-0 items-center">
                                    <div class="shrink-0">
                                        <img class="h-24 w-24 max-w-full rounded-lg object-cover" src="<?= $product->img; ?>" alt="" />
                                    </div>
                                    ...
                                    <div class="relative flex flex-1 flex-col justify-between">
                                            ...
                                            <div class="mt-4 flex items-end justify-between sm:mt-0 sm:items-start sm:justify-end">
                                                ...
                                                <div class="sm:order-1 mt-2 sm:mt-0 flex items-center">
                                                    <div class="mx-auto flex h-8 items-stretch text-gray-600">
                                                        ...
                                                        <div class="flex w-full items-center justify-center bg-gray-100 px-4 text-xs uppercase transition"><?= $_SESSION['panier'][$product->product_id]; ?></div>
                                        ...
                                        <div class="absolute right-16 mt-1 flex sm:bottom-0 sm:top-auto">
                                            <a href="panier.php?removeItems=<?= $product->product_id; ?>" class="flex rounded p-2 text-center text-gray-500 transition-all duration-200 ease-in-out focus:shadow hover:text-gray-900">
